...
public class ChatModel {
    ...
    StringProperty onlineStatus = new SimpleStringProperty();
    ...
    public void convertFromSvgToCanvas(String svgFormat) {
        ...
        int x = Integer.parseInt(words[2].replaceAll("[a-z=\"]",""));
        int y = Integer.parseInt(words[3].replaceAll("[a-z=\"]",""));
        double size = Double.parseDouble(words[4].replaceAll("[a-z=\"]",""));
